...
namespace ArticlesManager\Model\Behavior;
 ...
 * TAKEN FROM THIS REPO: https://github.com/dereuromark/cakephp-tools
 * THIS IS NOT MY CODE, BUT THE WORK OF THOSE MENTIONED ON THE ABOVE REPO!
 *
 * Usage: See docs
 *
 * @author Andy Dawson
